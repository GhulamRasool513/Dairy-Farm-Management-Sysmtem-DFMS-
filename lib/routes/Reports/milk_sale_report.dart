...
class MilkSaleReport extends StatefulWidget {
  static String id = 'MilkSaleReport';

  @override
  State<MilkSaleReport> createState() => _MilkSaleReportState();
}

class _MilkSaleReportState extends State<MilkSaleReport> {
    ...
    await firestore
      ...
      dates.add(TableRow(
          ...
          children: [
            ...
            StaffListColumn(columnName: 'Total Sale Price',fontSize: fontSize,),
          ]
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text('Milk Sale Report'),
      ),
