...
import 'package:khan_dairy/routes/Catalog/catalog_colors.dart';
        ...
        children: [
          ...
          MultiLevelTile(
            ...
            subLevelTiles: [
              ...
              SingleLevelTile(name: 'Add Salary', screen: AddSalary.id,),
              SingleLevelTile(
          ...
          MultiLevelTile(
              ...
              subLevelTiles: [
                ...
                SingleLevelTile(name: 'Milk Sale Due', screen: MilkSaleDue.id,)
              ]),

          //Cow Feed
          MultiLevelTile(
              icon: Icon(Icons.restaurant), name: 'Cow Feed', subLevelTiles: [
            SingleLevelTile(name: 'Add Cow Feed Information',
                screen: AddCowFeedInformation.id),
            SingleLevelTile(
                name: 'Cow Feed Information',
                screen: CowFeed.id),
          ...
          //Farm Expense
          MultiLevelTile(icon: Icon(FontAwesomeIcons.moneyBill1),
              name: 'Farm Expense',
              subLevelTiles: [
                SingleLevelTile(name: 'Add Farm Expense',screen: AddExpense.id,),
                SingleLevelTile(name: 'Farm Expense', screen: ExpenseList.id),
              ]),

          //Suppliers
          MultiLevelTile(icon: Icon(FontAwesomeIcons.users),
              name: 'Suppliers',
              subLevelTiles: [
                SingleLevelTile(name: 'Add Supplier', screen: AddSupplier.id,),
                SingleLevelTile(
                    name: 'Suppliers List',
                    screen: SuppliersList.id),
              ]),
          ...
          MultiLevelTile(
              ...
              name: 'Management',
              subLevelTiles: [
                SingleLevelTile(name: 'Add Cow', screen: AddCow.id,),
                SingleLevelTile(name: 'Manage Cow', screen: ManageCow.id),
                SingleLevelTile(name: 'Add Calf', screen: AddCalf.id,),
                SingleLevelTile(name: 'Manage Calf', screen: ManageCalf.id),
                SingleLevelTile(name: 'Add Stall', screen: AddStall.id,),
